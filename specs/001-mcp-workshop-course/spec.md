...
- **FR-001**: Workshop MUST deliver 11 distinct content blocks covering opening, fundamentals, anatomy, 5 practical exercises, security, orchestration, business cases, and closing within 3 hours total duration
...
- **FR-003**: Each practical exercise MUST include clear instructions, success criteria, and time boundaries (Exercise 1: 15 min, Exercise 2: 20 min, Exercise 3: 20 min, Exercise 4: 30 min, Exercise 5: 30 min)
...
- **FR-008.1**: Exercise 5 MUST guide attendees to create an AI agent using Microsoft Agent Framework that integrates multiple MCP servers for autonomous task execution
